					...
					<div className="row section-design" style={{ border: "1 solid black" }}>
						<div className="col-lg-8 mx-auto">
							...
							<div><label>Role</label></div>
								<div style={{ color: "#6c757d", opacity: 1 }}>
									<p><input type="radio"  value="Agent" name="role" onChange={(e) => this.handleRoleChange(e)} /> Agent</p>
									<p><input type="radio" checked value="User" name="role" onChange={(e) => this.handleRoleChange(e)} /> User</p>
